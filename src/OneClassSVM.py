...
def model_training(X_train):
    X_train_mini = X_train[:10000] # Prototyping with only 10000 instances.
...
def evaluation(oc_svm, X_test, y_test):
...
if __name__ == '__main__':
    X_train, X_test, y_test = setup()
    oc_svm = model_training(X_train)
    evaluation(oc_svm, X_test, y_test)
